...
class GUI(Tk):  # Graphic User Interface
    ...
    def __init__(self):
        ...
        self.labelframe = LabelFrame(self.tFrame, height=100, bd=1, bg="lightblue", text="This is a LabelFrame")
        ...
        self.labelframe2 = LabelFrame(self.tFrame, height=90, bg="pink", text="This is a LabelFrame2")
        ...
        self.labelframe3 = LabelFrame(self.tFrame, bg="lightgreen", text="This is a LabelFrame3")
